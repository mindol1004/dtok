    ...
    $.alopex.page({
        ...
        setGrid : function() {
            $("#gridMain").alopexGrid({
                ...
                columnMapping : [
                                 { columnIndex : 0,  key  : "WEEK_DT", 		   				title : "주간차수",		align : "center", 	width : "70px" },
                                 { columnIndex : 1,  key  : "SALE_DT",  					title : "매출일자",		align : "center", 	width : "70px" },
                                 { columnIndex : 2,  key  : "QTY_TOT",    					title : "합계",			align : "center", 	width : "70px" },
                                 { columnIndex : 3,  key  : "QTY_NEW", 						title : "010신규",		align : "center", 	width : "70px" },
                                 { columnIndex : 4,  key  : "QTY_KMNP", 					title : "KMNP",			align : "center", 	width : "70px" },
                                 { columnIndex : 5,  key  : "QTY_LMNP", 					title : "LMNP",			align : "center", 	width : "70px" },
                                 { columnIndex : 6,  key  : "QTY_EMNP", 					title : "기타 MNP",		align : "center", 	width : "70px" },
                                 { columnIndex : 7,  key  : "QTY_EQP_CHG", 					title : "기변",			align : "center", 	width : "70px" },
                                 { columnIndex : 8,  key  : "QTY_ETC", 						title : "기타",			align : "center", 	width : "70px" },
                                 { columnIndex : 9,  key  : "QTY_USIM", 					title : "USIM",			align : "center", 	width : "70px" },
                                 { columnIndex : 10, key  : "QTY_SMART", 					title : "스마트Device",	align : "center", 	width : "70px" },
                                 { columnIndex : 11, key  : "QTY_NEQP", 					title : "공기계",			align : "center", 	width : "70px" }
                             ],
                footer : {
		        			position : "top",
		        			footerMapping : [
