...
<div id="Wrap">
    ...
    <div class="pop_header"> 
        ...
        <p class="floatL2">
            <button id="btnConsult" value="" data-type="button" data-theme="af-n-btn6" data-altname="지원상담"></button>
            <button id="btnSupport" value="" data-type="button" data-theme="af-n-btn8" data-altname="지원서작성"></button>
            <button id="btnProcess" value="" data-type="button" data-theme="af-n-btn11" data-altname="진행현황"></button>
        </p>
