...
<div id="Wrap">
    ...
    <div class="pop_header"> 
        ...
        <p class="floatL2">
            <input id="btnConsult" value="" data-type="button" data-theme="af-n-btn6">  <!-- 지원상담요청 -->
            <input id="btnSupport" value="" data-type="button" data-theme="af-n-btn8">  <!-- 지원서작성 -->
            <input id="btnProcess" value="" data-type="button" data-theme="af-n-btn11"> <!-- 진행현황 -->
        </p>
