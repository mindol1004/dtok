...
<head>
    ...
    var _TX_SAVE    = "com.MODE@PMODEMGMT001_pSaveModeMgmt";
    var arrs             =           new Array();
    $.alopex.page({
        ...
        setGrid : function() {
            $("#grid").alopexGrid({
                ...
                columnMapping : [
                    { columnIndex : 0, key : "FLAG",                        title : "F",            align : "center",   width : "10px",
                        value : function(value, data) {
                            return ( (data._state.edited) ? 'U' : '' ); 
                        }
                    } ,
                    { columnIndex : 1, key : "DOW_NM",                      title : "요일",         align : "center",   width : "20px"  } ,
                    { columnIndex : 2, key : "HDQT_TEAM_ORG_NM",            title : "본사팀",       align : "center",   width : "60px"  } ,                    
                    { columnIndex : 3, key : "HDQT_PART_ORG_NM",            title : "본사파트",     align : "center",   width : "60px"  } ,
                    { columnIndex : 4, key : "APLY_YN",                     title : "적용여부",     align : "center",   width : "28px", 
                    ...
                    { columnIndex : 5, key : "APLY_STA_H",                  title : "시작 시",         align : "center",   width : "20px",
                        editable : { 
                            type : "select", 
                            rule : function(value, data) {
                                var data = [];
                    ...
                    { columnIndex : 7, key : "APLY_STA_M",                  title : "시작 분",         align : "center",   width : "20px" ,
                        editable : { 
                            type : "select", 
                            rule : function(value, data) {
                                var ar = [];
                    ...
                    { columnIndex : 9, key : "APLY_END_H",                  title : "종료 시",         align : "center",   width : "20px",
                        editable : { 
                             type : "select", 
                             rule : function(value, data) {
                                var data = [];
                    ...
                    { columnIndex : 11, key : "APLY_END_M",                  title : "종료 분",         align : "center",   width : "20px" ,
                        editable : { 
                            type : "select", 
                            rule : function(value, data) {
                                var ar = [];
        ...
        setCode : function() {
            $.alopex.request("com.MODE@PMODEMGMT001_pSearchday", {
        ...
        setDate : function() {
            $.alopex.request("com.MODE@PMODEMGMT001_pSearchToDay", {
                success : function(res) {
        ...
        searchList: function(param) {
            $.alopex.request("com.MODE@PMODEMGMT001_pSearchModeMgmt", {
...
<div id="contents">
    ...
    <div class="content_title">
        <div id="ub_txt6">
            <span class="txt6_img"><b id="sub-title">모드관리</b>
    ...
    <div id="searchDiv" class="textAR">
        <form id="searchForm">
            ...
            <tbody>
            <tr>
                <th scope="col"class="fontred">요일</th>
                <td class="tleft">
        ...
        <div class="floatL4"><img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"><b>모드관리</b>
        <p class="ab_pos2">
