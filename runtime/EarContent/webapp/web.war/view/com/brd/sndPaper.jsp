        ...
        setGrid : function() {
            $("#gridpaper").alopexGrid({
                ...
                columnMapping : [   //컬럼맵핑     
                    ...
                    { 
                        columnIndex : 6, key : "TITLE", title : "내용", align : "left", width : "100px" 
        ...
        <form id="searchForm" onsubmit="return false;">
            <table id="searchTable" class="board02" style="width:92%;">
                <tr>
                    ...
                    <td class="tleft">
                        <select id="PAPER_COND_CD" data-bind="selectedOptions: PAPER_COND_CD" data-type="select" data-wrap="false" data-codeid="PAPER_COND_CD" style="width:150px;">
                            <option value="">-전체-</option>
                            <option value="01">(01) 받는사람 </option>
                            <option value="02">(02) 제목 </option>
                            <option value="03">(03) 내용 </option>
                        </select>
                    </td>
