        ...
        <form id="form" onsubmit="return false;">
			...
			<input id="FILE_SIZE" name="FILE_SIZE" data-bind="value:FILE_SIZE" type="hidden" data-type="textinput" />
			    ...
			    <tr>
			        ...
			        <td colspan="2" class="tleft">
						<input type="radio" name="WEDD_YN" value="Y" data-bind="checked:WEDD_YN" data-type="radio" onclick="$('#WEDD_DT').setEnabled(true)">
        				기혼
			    ...
			    <tr>
			        ...
			        <td class="tleft" colspan="2"><button id="btnExcelSaleEx" type="button" data-type="button" data-theme="af-n-btn16" data-authtype="R" data-altname="상세조회" class="af-button af-n-btn16"></button></td>
			    </tr>
			    <tr>
			        <th scope="col">메모</th>
