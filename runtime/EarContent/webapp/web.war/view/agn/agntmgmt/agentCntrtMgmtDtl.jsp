...
<head>
    ...
    $.alopex.page({
        ...
        setEventListener : function() {        	
            ...
            $("#btnReturnCancel").click(function(){  // 반려취소버튼 클릭
        ...
        setCodeData : function() {
            $.PSNMUtils.setCodeData([
                ...
                { t:'org2',  'elemid' : 'HDQT_PART_ORG_ID_1', 'header' : '-전체-' }, //본사파트
        	...
        	if($.PSNMUtils.isNotEmpty(param.CNTRT_MGMT_NUM)){
        		...
        		$.alopex.request('agn.AGNTMGMT@PAGENTCNTRT001_pDetailAgentCntrt', {
            		...
            		success : ["#detailForm", "#gridSchship", "#gridCareer", "#gridIntHst", function(res){
            			...
            			$a.page.setViewBtn(res.dataSet.fields.CNTRT_ST_CD);  //계약상태코드에 따른 버튼 활성화처리
        ...
        setViewBtn : function(cntrtStCd){
            ...
            //$("#btnIntDel").hide();         // 면접결과 추가버튼
            
            $("#btnFindAgent").hide();      // 에이전트찾기 버튼
            
          
        	//요청(1),접수(2),면접완료(21),계약승인(3),코드발급완료(4),반려(5),회원가입완료(6)
        	...
        	switch(cntrtStCd){
	        	...
	        	case "3" : $("#btnApproveCancel").show();  //승인취소버튼
	        	           ...
	        	           $("#btnFindAgent").show();      //에이전트찾기버튼
	            	        break;
	            //반려
	            case "5" : $("#btnReturnCancel").show();    //반려취소버튼
	                        break;
	        	default : 
			              break; 
        	}
        ...
        updateByStaff : function(msg, cntrtStsCd, cntrtChkCd){
        	...
        	$.alopex.request('agn.AGNTMGMT@PAGENTCNTRT001_pUpdateAgentCntrt', {
                ...
                success : function(res) {
                	...
                	//$("#APL_ST_CD").setSelected(res.dataSet.fields.APL_ST_CD);
...
<div id="contents">
	...
	<div class="content_title">
       <div class="ub_txt6">
          <span class="txt6_img"><b id="sub-title">MA지원서</b>
	...
	<div class="btn_area">	
		<div class="ab_btn_left">
            <button id="btnReceipt"       type="button" data-type="button" data-theme="af-btn92" data-altname="접수"></button>
            <button id="btnReceiptCancel" type="button" data-type="button" data-theme="af-btn7"  data-altname="접수취소"></button>
            <button id="btnApprove"       type="button" data-type="button" data-theme="af-btn5"  data-altname="승인"></button>
            <button id="btnApproveCancel" type="button" data-type="button" data-theme="af-btn93" data-altname="승인취소"></button>
            <button id="btnReturn"        type="button" data-type="button" data-theme="af-btn6"  data-altname="반려"></button>            
            <button id="btnReturnCancel"  type="button" data-type="button" data-theme="af-btn94" data-altname="반려취소"></button>
        </div>        
    ...
    <form id="detailForm" onsubmit="return false;">
		...
		<!-- 월별판매계획 area -->
		<div class="floatL4"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>월 별 판매계획</b> </div>
        <div class="view_table vline">
            <table data-type="table">
                ...
                <tbody class="table-body">
                    <tr class="row-odd">
                        <td>
                            <input id="QUART1_MTH_AVG_QTY" data-bind="value:QUART1_MTH_AVG_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                        <td>
                            <input id="QUART1_MTH_TOT_QTY" data-bind="value:QUART1_MTH_TOT_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                        <td>
                            <input id="QUART2_MTH_AVG_QTY" data-bind="value:QUART2_MTH_AVG_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                        <td>
                            <input id="QUART2_MTH_TOT_QTY" data-bind="value:QUART2_MTH_TOT_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                        <td>
                            <input id="SHYR_MTH_AVG_QTY" data-bind="value:SHYR_MTH_AVG_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                        <td>
                            <input id="SHYR_MTH_TOT_QTY" data-bind="value:SHYR_MTH_TOT_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                        <td>
                            <input id="YR_MTH_AVG_QTY" data-bind="value:YR_MTH_AVG_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                        <td>
                            <input id="YR_MTH_TOT_QTY" data-bind="value:YR_MTH_TOT_QTY" data-type="textinput" data-disabled="true" style="text-align:center">
                        </td>
                    </tr>
                </tbody>
            </table>
		...
		<div class="view_table vline">
			...
			<tr class="row-odd">
		        <td>
		            <input id="REQ_HDQT_PART_ORG_NM" data-bind="value:REQ_HDQT_PART_ORG_NM" data-type="textinput" data-disabled="true" style="text-align:center">
		        </td>
		        <td>
		            <input id="REQ_SALE_DEPT_ORG_NM" data-bind="value:REQ_SALE_DEPT_ORG_NM" data-type="textinput" data-disabled="true" style="text-align:center">
		        </td>
		        <td>
		            <input id="REQ_SALE_TEAM_ORG_NM" data-bind="value:REQ_SALE_TEAM_ORG_NM" data-type="textinput" data-disabled="true" style="text-align:center">
		        </td>
		        <td>
		            <select id="HDQT_PART_ORG_ID" data-type="select" data-bind="options:options_HDQT_PART_ORG_ID, selectedOptions:HDQT_PART_ORG_ID" data-wrap="false"
		                    data-validation-rule="{required:true}"
                            data-validation-message="{required:$.PSNM.msg('E012', ['지정지역명'])}">
                       <option value="">-전체-</option>
                    </select>
		        </td>
		        <td>
		            <select id="SALE_DEPT_ORG_ID" data-type="select" data-bind="options:options_SALE_DEPT_ORG_ID, selectedOptions:SALE_DEPT_ORG_ID" data-wrap="false"
		                    data-validation-rule="{required:true}"
		        ...
		        <td>
		            <select id="SALE_TEAM_ORG_ID" data-type="select" data-bind="options:options_SALE_TEAM_ORG_ID, selectedOptions:SALE_TEAM_ORG_ID" data-wrap="false"
		                    data-validation-rule="{required:true}"
		...
		<div class="floatL4"> <img src="<c:out value='${pageContext.request.contextPath}'/>/image/blat_a7.gif"> <b>면접결과</b>
            <div class="ab_pos1">
                ...
                <button id="btnIntDel" data-type="button" data-theme="af-btn28" data-altname="삭제" style="display:none;"></button>
		...
		<div class="view_table vline">
            ...
            <tr class="row-odd">
                <td>
                    <input id="HDQT_PART_ORG_NM" data-bind="value:HDQT_PART_ORG_NM" data-type="textinput" data-disabled="true" style="width:100%;text-align:center">
                </td>
                <td>
                    <input id="SALE_DEPT_ORG_NM" data-bind="value:SALE_DEPT_ORG_NM" data-type="textinput" data-disabled="true" style="width:100%;text-align:center">
                </td>
                <td>
                    <input id="SALE_TEAM_ORG_NM" data-bind="value:SALE_TEAM_ORG_NM" data-type="textinput" data-disabled="true" style="width:100%;text-align:center">
                </td>
                <td>
                    <input id="CNTRT_ST_NM" data-bind="value:CNTRT_ST_NM" data-type="textinput" data-disabled="true" style="width:100%;text-align:center">
                </td>
                <td>
                    <input id="APRVR_NM" data-bind="value:APRVR_NM" data-type="textinput" data-disabled="true" style="width:100%;text-align:center">
                </td>
                <td>
                    <input id="APRV_DTM" data-bind="value:APRV_DTM" data-type="textinput" data-disabled="true" style="width:100%;text-align:center">
                </td>
                <td>
                    <input id="APRVR_CMNT" data-bind="value:APRVR_CMNT" data-type="textinput" data-disabled="false" style="width:100%"/>
                </td>
            </tr>
            </tbody>
            </table>
		...
		<div class="view_table vline">
            ...
            <tr class="row-odd">
                <td>
                    <input id="AGNT_ID" data-bind="value:AGNT_ID" data-type="textinput" data-disabled="true" style="text-align:center">
                ...
                <td>
                    <input id="AGENT_OPR_NM" data-bind="value:AGENT_OPR_NM" data-type="textinput" data-disabled="true" style="text-align:center">
                </td>
                <td>
                    <input id="AGENT_OP_DTM" data-bind="value:AGENT_OP_DTM" data-type="textinput" data-disabled="true" style="text-align:center">
                </td>
            </tr>
            </tbody>
            </table>
