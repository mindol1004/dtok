        ...
        setGrid : function() {
            $("#grid").alopexGrid({
                ...
                columnMapping : [
                    ...
                    { columnIndex : 7, key : "HEADQ_YN",			title : "사무국배정여부",	align : "center", 	width : "100px"	},
                    { columnIndex : 8, key : "SMS_YN",			    title : "SMS수신여부<br/>※ SMS발송화면적용",	align : "center", 	width : "100px"	},
